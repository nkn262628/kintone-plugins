(function () {
  ...
  // ══════════════════════════════════════════════
  const TOAST_STYLES = {
   success: { bg: '#eef4f0', border: '#a9c4b3', text: '#3d6350', icon: '✓' },
error:   { bg: '#fbedeb', border: '#e5857b', text: '#a8483c', icon: '✕' },
warn:    { bg: '#fdf1f1', border: '#f1b2b2', text: '#8a4a45', icon: '⚠' },
info:    { bg: '#eef1f7', border: '#7d8bae', text: '#45496a', icon: 'ℹ' },
  };
  let _toastEl = null;
